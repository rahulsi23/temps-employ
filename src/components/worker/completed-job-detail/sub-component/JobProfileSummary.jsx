...
const JobProfileSummary = () => {
  return (
    <>
    <div className='jobprfl-sumary'>
    <div className="card hirng-card">
                      <div className="hirngcrd-mdl">
                        ...
                        <p className="para-descrp">We are seeking reliable and experienced kitchen staff to join our team at XYZ Restaurant</p>
                      </div>
...
export default JobProfileSummary